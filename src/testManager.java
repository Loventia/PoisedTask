...
//initialize Scanner object
          ...
          String choiceSelected = input.nextLine();
          ...
          if (choiceSelected.equals("1")) {
              ...
              * Added try catch block to make sure user inputs correct format
              */
              int contractorNumber = 0;// initialize variable
              while (true) {
                  try {
                      System.out.println("Enter Contactor number:");
              ...
              * Create Project
              */
              Project newProject = new Project(ProjectNumber, typedProjectName, typedBuildingType,
          ...
          else if (choiceSelected.equals("2")) {
          ...
          else if (choiceSelected.equals("3")) {
          ...
          else if (choiceSelected.equals("4")) {
          ...
          } else if (choiceSelected.equals("7")) {
          ...
          } else if (choiceSelected.equals("8")) {
